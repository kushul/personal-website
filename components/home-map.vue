<template>
  <div>
    ...
    <h2
      class="subtitle"
    >Mauritius 🇲🇺, the paradise island which is located off the southeast coast of the African continent in the Indian Ocean.</h2>
    <ul class="radar">
      <li></li>
      <li></li>
      <li></li>
...
.radar {
  ...
  border-radius: 50%;
  border: 20px solid;
  background: #000 url('../assets/images/map.png') no-repeat;
